...
The text from these pages enriches your drafts with broader context.

These exact links are stored in the serp_debug sheet so you always know the research sources.
